...
import com.soptie.server.member.service.dto.response.routine.daily.MemberDailyRoutineListGetServiceResponse.MemberDailyRoutineServiceResponse;
...
public class MemberRoutineServiceIntegrationTest {
	...
	class Acquire {
		...
		void getMemberDailyRoutinesByMember() {
			...
			MemberDailyRoutineListGetServiceRequest request = MemberDailyRoutineListGetServiceRequest.of(
				member1.getId());
