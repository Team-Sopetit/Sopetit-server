...
public record HappinessRoutineListGetServiceResponse(List<HappinessRoutineServiceResponse> routines) {
	...
	public record HappinessRoutineServiceResponse(
		long routineId, @NonNull String themeName, @NonNull String themeColor,
		@NonNull String content, @NonNull String iconImageUrl
	) {
